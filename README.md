...
![npm](https://img.shields.io/npm/v/ai-resume)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-resume)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Resume generation and optimization utilities

Resume generator and optimizer. Creates professional resumes with ATS optimization.
...
[![GitHub stars](https://img.shields.io/github/stars/lxgicstudios/ai-resume)](https://github.com/lxgicstudios/ai-resume/stargazers)
...
npx ai-resume "junior frontend dev, 1 year Vue.js" -o my-resume.md
```
